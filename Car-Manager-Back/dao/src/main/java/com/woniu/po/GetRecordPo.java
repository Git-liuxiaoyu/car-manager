...
public class GetRecordPo {
    ...
    public GetRecordPo(Integer id, Integer carId, Integer oppositeCompanyId, OppositeCompanyPo ocpo, Integer reapairType, String sendTime, String getTime, BigDecimal cost, String repairItem, String material, String remarks) {
        this.id = id;
        this.carId = carId;
