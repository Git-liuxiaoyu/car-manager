  ...
  <div>
    ...
    <template>
      <el-table :data="keeplist" border style="width: 100%" max-height="377"
        ...
        <el-table-column prop="typename" label="保养类别" min-width>


        </el-table-column>

        <el-table-column prop="keepDate" label="保养时间" min-width>

        </el-table-column>

        <el-table-column prop="nextKeepTime" label="下次保养时间" min-width>

        </el-table-column>

        <el-table-column prop="fee" label="保养金额" min-width>

        </el-table-column>

        <el-table-column prop="oppositename" label="保养单位" min-width>

        </el-table-column>

        <el-table-column prop="thisKeepMileage" label="本次保养里程" min-width>

        </el-table-column>

        <el-table-column prop="nextKeepMileage" label="下次保养里程" min-width>

        </el-table-column>

        <el-table-column prop="drivername" label="操作人员" min-width>

        </el-table-column>

        <el-table-column prop="remarks" label="备注" min-width>
