...
<template>
 <el-table :data="keeplist"  style="width: 100%" height="470">
        
        <!-- <el-table-column prop="id" label="编号" width="80">
         
        </el-table-column> -->

        <el-table-column prop="carNum" label="车牌号" width="100">
         
        </el-table-column>

        <el-table-column prop="typename" label="保养类别" width="120">
          

        </el-table-column>

        <el-table-column prop="keepDate" label="保养时间" width="100">
         
        </el-table-column>

        <el-table-column prop="nextKeepTime" label="下次保养时间" width="120">
         
        </el-table-column>

        <el-table-column prop="fee" label="保养金额" width="100">
         
        </el-table-column>

        <el-table-column prop="oppositename" label="保养单位" width="100">
         
        </el-table-column>

        <el-table-column prop="thisKeepMileage" label="本次保养里程" width="120">
         
        </el-table-column>

        <el-table-column prop="nextKeepMileage" label="下次保养里程" width="120">
         
        </el-table-column>

        <el-table-column prop="drivername" label="操作人员" width="100">
...
export default {
    data() {
     ...
     methods:{
            //列表
    keepfindlist(){   
      this.$axios.get("keeprecord/list",{params: {p: this.p, searchText: this.searchText, size: this.size}}).then(r => {
